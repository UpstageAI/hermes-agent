...
| [`simplify`](/docs/user-guide/skills/bundled/software-development/software-development-simplify) | Parallel 3-agent cleanup of recent code changes. | `software-development/simplify` |
